...
export function Header({
  ...
  return (
    <div className="flex items-center justify-between border-b border-nau-line px-8 py-5 lg:px-12">
      ...
      <div className="flex items-center gap-6">
        <span className="font-mono text-[11px] tracking-mono text-nau-fg-dim">{meta}</span>
        ...
        {onOpenSettings && (
          <button
            ...
            className="text-nau-fg-dim transition-colors hover:text-nau-accent"
          >
